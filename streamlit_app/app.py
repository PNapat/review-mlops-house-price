    ...
    if predict_button:
        ...
        with st.spinner("Calculating prediction..."):
            ...
            try:
                ...
                api_endpoint = os.getenv("API_URL", "http://model-review:8000")
...
version = os.getenv("APP_VERSION", "3.0.0")  # Default version if not set in environment # selfnote: (for human to see)
